...
export const OCWNewYear = () => {
  ...
  const progressValue = ((Number(currentPrize) / Number(prize)) * 100).toFixed(
    2,
  );
      ...
      <motion.div
        ...
        <Block className="col-span-12 row-span-2 md:col-span-6 justify-between flex flex-col">
          <div className="font-bold">
            ...
            <p className="mt-4 text-3xl sm:text-3xl md:text-4xl lg:text-5xl">
              {prize} ETH
            </p>
        ...
        <Block className="col-span-7 md:col-span-7 text-3xl flex flex-col items-center text-center justify-center">
          <p className="text-orange-400 text-base md:text-3xl">
            Total Ticket Sold
          </p>
