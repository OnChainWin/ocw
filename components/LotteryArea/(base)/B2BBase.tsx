...
export const B2BPageAreaBase = () => {
  ...
  return (
    <div className="min-h-screen px-4 py-12 text-zinc-50">
      ...
      <p className="items-center text-black dark:text-white text-center text-2xl font-medium text-pretty mt-2">
        Start Bitcoin mining in 1 day with GoMining
      </p>
      <div className="flex justify-center py-2">
        <Image
          src="/sales/gomining.jpg"
          alt="logo"
          width={250}
          height={250}
      ...
      <div className="text-center text-lg mb-4 font-semibold text-black dark:text-white">
        Find more information{" "}
        <Link
          href="https://gomining.com/?ref=nVxtE"
          className="text-blue-500 font-bold hover:underline"
          target="_blank">
          here
        </Link>
        <br />
        Annual Net Bitcoin Mining: 0.00550275 BTC
      </div>
      <motion.div
        initial="initial"
        animate="animate"
        ...
        <Block className="col-span-12 row-span-2 md:col-span-6 justify-between flex flex-col">
          <div className="font-bold">
            <p className="text-2xl text-blue-300 sm:text-3xl md:text-4xl lg:text-5xl">
              Prize
            </p>
          ...
          <div className="border-t-2 border-collapse border-white/90 mb-4" />
          <p className="text-2xl">48 TH 20W</p>
