  ...
  return (
    <div className="relative">
      <div className="relative xl:container m-auto px-6 md:px-12 lg:px-6">
        <h1 className="sm:mx-auto sm:w-10/12 md:w-2/3 font-black text-dark-950 text-4xl text-center sm:text-5xl md:text-6xl lg:w-auto lg:text-left xl:text-7xl dark:text-white">
          From community <br className="lg:block hidden" />{" "}
          <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-orange-500 dark:from-orange-400 dark:to-orange-300">
            to Community
          </span>
          .
        </h1>
        <div className="lg:flex">
          <div className="relative mt-8 md:mt-16 space-y-8 sm:w-10/12 md:w-2/3 lg:ml-0 sm:mx-auto text-center lg:text-left lg:mr-auto lg:w-7/12">
            <p className="sm:text-lg text-gray-700 dark:text-gray-300 lg:w-11/12">
              The elimination of the human factor from the equation is not a
              luxury; it’s a necessity.
            </p>
            <p>
              Our commitment to transparency extends to our smart contract and
              transaction history, both of which are readily accessible for
              public viewing on our website or through any reputable third-party
              transaction tracker
            </p>

            <span className="block font-semibold text-gray-500 dark:text-gray-400">
              The first fully decentralized lottery.
            </span>
            <div className="grid grid-cols-3 lg:grid-cols-6 gap-4 md:space-x-6 md:flex md:justify-center lg:justify-start  flex-none">
              <a
              ...
              <Link
                href="/communitycall"
                target="_blank"
                className="p-4 border flex-shrink-0 z-10 border-gray-200  dark:border-gray-700 rounded-full duration-300 hover:border-orange-400 hover:shadow-xl hover:shadow-orange-600 dark:hover:border-orange-300">
                <div className="flex justify-center space-x-4">
                  <Image
                    src={"/logo.png"}
                    alt="discord"
          ...
          <div className="mt-12 md:mt-0 lg:absolute -right-10 lg:w-7/12">
            <div className="relative w-full">
              <div
                aria-hidden="true"
                className="absolute scale-75 md:scale-80 inset-0 m-auto w-full h-full md:w-96 md:h-96 rounded-full rotate-45 bg-gradient-to-r from-orange-500 to-orange-300 blur-3xl"></div>
              <Image
                src={"/ethereum.svg"}
                alt="community"
                width={400}
                height={400}
                className="justify-center relative sm:ml-44 ml-2"
                priority
              />
            </div>
          </div>
