  ...
  return (
    <div>
      <div className="flex inset-0">
        <Sheet>
          <SheetTrigger>
            <AlignJustify className="hover:cursor-pointer hover:scale-110 ease-in-out transition-all duration-300 hover:stroke-orange-300" />
          </SheetTrigger>
          <SheetContent
            side={"left"}
            className="dark:bg-[#2b2b2b] bg-white bg-opacity-100">
            <div className="mt-2 flex items-center justify-center">
              <Link href={"/"}>
                <Image
                  ...
                  width={76}
                  height={76}
                  className="hover:cursor-pointer hover:scale-110 ease-in-out transition-all duration-500 hidden md:block"
                />
              </Link>

              <Link
                href={"/profile"}
                className="items-center border-b border-gray-200 my-2 flex flex-col w-full h-full md:hidden">
                <p className="text-base text-lime-500 font-bold font-mono hover:scale-110 ease-in-out hover:duration-300 transition-all">
                  Profile Page
                </p>
                <RxAvatar className="size-12 mb-2 rounded-full p-1 hover:scale-110 ease-in-out hover:duration-300 transition-all" />
              </Link>
            </div>

            <div className="md:space-y-4 space-y-1 md:border-t md:border-gray-200 items-center flex flex-col md:py-4 py-1">
              <SheetTrigger className="flow-root">
                <Link
                  href="/play"
              ...
              <div className="flow-root">
                <Link
                  href={"/blog"}
                  className="-m-2 block text-orange-500 p-2 font-medium hover:cursor-pointer hover:text-orange-600 ">
                  Blog
                </Link>
              </div>

              <div className="grid sm:grid-cols-3 grid-cols-3 justify-items-center gap-4 flex-nowrap">
                <a
              ...
              <Link
                href={"/profile"}
                className="space-y-4 border-t border-gray-200 items-center md:flex flex-col py-4 w-full h-full hidden">
                <p className="text-2xl text-lime-500 font-bold font-mono hover:scale-110 ease-in-out hover:duration-300 transition-all">
                  Profile Page
                </p>
                <RxAvatar className="size-24 border-b rounded-full p-3 hover:scale-110 ease-in-out hover:duration-300 transition-all" />
              </Link>
              ...
              <Link href={"/"}>
                <Image
                  ...
                  width={76}
                  height={76}
                  className="hover:cursor-pointer hover:scale-110 ease-in-out transition-all duration-500 md:hidden block mt-4"
                />
              </Link>
            </div>
          </SheetContent>
