...
import {
  FREE_PARTNERSHIP2_ABI,
  FREE_PARTNERSHIP2_CONTRACT_ADDRESS,
...
export const MonsterPageArea = () => {
  ...
  const FOCWWEvents = async () => {
    ...
    // const fromBlock = BigInt(latestBlock) - 10000n;
  ...
  const buyTicket = async () => {
    writeContract({
      abi: FREE_PARTNERSHIP2_ABI,
      address: FREE_PARTNERSHIP2_CONTRACT_ADDRESS,
      account: address,
    ...
    <div className="min-h-screen px-4 py-12 text-zinc-50">
      <div className="flex flex-col items-center gap-2 my-4 text-center justify-center">
        ...
        <h1 className="text-black dark:text-white text-2xl font-bold font-sans">
          OCW x Monsters Partnership Raffle
        </h1>
        <Image
          src={"/monsters/logo.png"}
          alt="Monsters Logo"
      ...
      <div className="flex flex-row gap-1 sm:gap-6 items-center justify-center mb-5">
        ...
        <Image
          ...
          width={100}
          height={100}
          className="rounded-md shadow-sky-300 shadow-xl size-12 md:size-40"
        />
        <Image
          src={"/monsters/3.png"}
          alt=""
          width={100}
          height={100}
          className="rounded-md shadow-sky-700 shadow-xl size-12 md:size-40"
        />
        <Image
          src={"/monsters/4.png"}
          alt=""
          width={100}
          height={100}
          className="rounded-md shadow-gray-700 shadow-xl size-12 md:size-40"
        />
        <Image
          src={"/monsters/5.png"}
          alt="Varonve"
          width={100}
          height={100}
          className="rounded-md shadow-blue-400 shadow-xl size-12 md:size-40"
        />
      </div>
      <motion.div
        initial="initial"
            ...
            <table className="table-fixed w-full text-white">
              ...
              <tbody className="max-md:text-sm">
                {[...players].reverse().map((play, index) =>
                  // burası 0x001 clipper için kontrol / winner ve playerda da var.
                  play.giveawayHash == 0x001 ? null : (
            ...
            <table className="table-fixed w-full text-black">
              ...
              <tbody className="max-md:text-sm text-black">
                {[...winners].reverse().map((win, index) =>
                  win.prizeAmount == 777 ? null : ( // prizeAmount 777 ise satır render edilmez
                    <tr key={index} className="hover:opacity-80">
                      <td className="border px-4 text-center py-2">
...
export default MonsterPageArea;
