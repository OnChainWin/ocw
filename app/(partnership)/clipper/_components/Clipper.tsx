...
export const ClipperPageArea = () => {
  ...
  const calculateChance: number = (perTicketNumber * totalWinners / soldTicketsNumber) * 100;
    ...
    <div className="min-h-screen px-4 py-12 text-zinc-50">
      <div className="flex flex-col items-center gap-2 my-4 text-center justify-center">
        ...
        <h1 className="text-black dark:text-white text-2xl font-bold font-sans">
          OCW x Clipper Partnership Raffle
        </h1>
        <Image
          src={"/clipper/clipper.jpeg"}
          alt="Clipper Logo"
          width={125}
          height={125}
      ...
      <div className="flex flex-row gap-2 sm:gap-10 items-center justify-center mb-5">
        <Image
          ...
          width={200}
          height={200}
          className="rounded-md shadow-pink-300 shadow-xl size-20 md:size-40"
        />
        <Image
          src={"/clipper/2.jpg"}
          alt="Clipper"
          width={200}
          height={200}
          className="rounded-md shadow-pink-100 shadow-xl size-20 md:size-40"
        />
        <Image
          src={"/clipper/3.jpg"}
          alt="Clipper"
          width={200}
          height={200}
          className="rounded-md shadow-purple-200 shadow-xl size-20 md:size-40"
        />
        <Image
          src={"/clipper/4.jpg"}
          alt="Clipper"
          width={200}
          height={200}
          className="rounded-md shadow-yellow-200 shadow-xl size-20 md:size-40"
        />
      </div>
      <motion.div
        initial="initial"
...
export default ClipperPageArea;
