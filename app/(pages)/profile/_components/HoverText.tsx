  ...
  return (
    <div
      ...
      <div className="relative mt-1 h-1 w-full">
        <div
          className={cn(
            "absolute left-0 top-0 h-full w-full bg-gradient-to-r from-[#e65c00] to-[#F9D423] transition-transform duration-300",
            isHoveredIn
        ...
        <div
          className={cn(
            "absolute left-0 top-0 h-full w-full translate-x-0 transform bg-orange-500 opacity-0 transition-transform duration-300",
