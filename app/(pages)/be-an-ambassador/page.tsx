...
const BeAnAmbassadorPage = (props: Props) => {
  ...
  return (
    <Fragment>
      <div className="min-h-screen -mt-12 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:text-white"
                  placeholder="Tell us about yourself and why do you want to be an ambassador"
                />
              </div>
...
export default BeAnAmbassadorPage;
